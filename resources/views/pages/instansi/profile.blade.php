...
@section('content')
    <div class="d-flex justify-content-between align-items-start mb-3">
        ...
        <a href="{{ Route::has('instansi.perda_perwali.index') ? route('instansi.perda_perwali.index') : '#' }}"
    ...
    <x-modal_profile_form :profile="$profile" update-route="instansi.profile.update" />
@endsection