...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        <h1 class="page-title mb-1">Profil Sekretariat Daerah</h1>
        <p class="page-description mb-0">Informasi profil Sekretariat Daerah.</p>
    </div>
</div>
...
@if ($profile)
    <div class="card-custom p-4">
        <h5 class="section-title text-start mb-4">Data Profil Sekretariat Daerah</h5>
...
@else
    <div class="card-custom empty-profile">
        ...
        <p>Silakan tambahkan data profil Sekretariat Daerah terlebih dahulu.</p>
    </div>
@endif

<x-instansi.profile.modal-profile :profile="$profile" />
...
<style>
    ...
    .empty-icon { font-size: 45px; color: #2878d7; margin-bottom: 12px; }
    .empty-profile h5 { color: #173b69; font-size: 16px; margin-bottom: 6px; }
    .empty-profile p { color: #a5a9b2; font-size: 12px; margin-bottom: 0; }
    .profile-item { margin-bottom: 20px; }
    .profile-label { color: #173b69; font-size: 11px; font-weight: 600; margin-bottom: 5px; }
    .profile-value { color: #333; font-size: 13px; min-height: 20px; }
</style>
@endpush