...
<div class="modal fade" id="modalEditPerwali{{ $perwali->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ Route::has('instansi.perwali.update') ? route('instansi.perwali.update', $perwali->id) : '#' }}">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <textarea name="tentang" class="form-control" rows="5" style="resize: vertical; min-height: 120px;">{{ $perwali->tentang ?? '' }}</textarea>
                    </div>
                </div>
