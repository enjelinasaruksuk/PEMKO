...
@php
    $penyampaianFields = [
        'persyaratan' => '1. Persyaratan',
        'sistem_mekanisme_prosedur' => '2. Sistem, Mekanisme dan Prosedur',
        'jangka_waktu' => '3. Jangka Waktu Pelayanan',
        'biaya' => '4. Biaya',
        'produk_pelayanan' => '5. Produk Pelayanan',
        'penanganan_pengaduan' => '6. Penanganan, Pengaduan, Saran dan Masukkan',
    ];

    $pengelolaanFields = [
        'dasar_hukum' => '1. Dasar Hukum',
        'sarana_prasarana' => '2. Sarana dan Prasarana dan/atau fasilitas',
        'kompetensi_pelaksana' => '3. Kompetensi Pelaksana',
        'pengawasan_internal' => '4. Pengawasan Internal',
        'jumlah_pelaksana' => '5. Jumlah Pelaksana',
        'jaminan_pelayanan' => '6. Jaminan Pelayanan',
        'jaminan_keamanan' => '7. Jaminan Keamanan dan Keselamatan Pelayanan',
        'evaluasi_kinerja' => '8. Evaluasi Kinerja Pelaksana',
    ];
@endphp
...
<div class="card-custom p-4 mb-4">
    ...
    @foreach ($penyampaianFields as $name => $label)
        ...
        <div class="mb-4">
            <label class="form-label-custom fw-semibold">{{ $label }}</label>
            <textarea name="{{ $name }}" id="{{ $name }}" class="rich-text-hidden d-none">{{ $value }}</textarea>
            <div id="editor-{{ $name }}" class="rich-text-editor">{!! $value !!}</div>
        </div>
    @endforeach
</div>
